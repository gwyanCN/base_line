...
if __name__ == "__main__":
    ...
    parser.add_argument('-pred_file', default="/home/b227/ygw/Dcase2022/new_frame_level/DCASE2021Task5-main/src/src/output_csv/tim/Eval_out_tim_post.csv",type=str, help='csv predictions file')
    parser.add_argument('-ref_files_path',default="/home/b227/ygw/Dcase2021/Development_Set(1)/Development_Set/Validation_Set/", type=str, help='path to the ground truth csvs folder')
