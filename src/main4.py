...
def main(conf : DictConfig):
    ...
    if conf.set.eval: # eval
        ...
        for i in range(TOTAL_LENGTH//4 *3,TOTAL_LENGTH):
        ...
        csv_path_ori = os.path.join(conf.path.work_path,'src','output_csv','ori','Eval_out_ori_4.csv')
        ...
        csv_path_tim = os.path.join(conf.path.work_path,'src','output_csv','tim','Eval_out_tim_4.csv')
