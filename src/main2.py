...
def main(conf : DictConfig):
    ...
    if conf.set.eval: # eval
        ...
        csv_path_ori = os.path.join(conf.path.work_path,'src','output_csv','ori','Eval_out_ori_2.csv')
        ...
        csv_path_tim = os.path.join(conf.path.work_path,'src','output_csv','tim','Eval_out_tim_2.csv')
