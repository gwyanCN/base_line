val_path_="/media/b227/ygw/Dcase2023/data/Development_Set_22/Validation_Set/"
ref_files_path_="/media/b227/ygw/Dcase2023/data/Development_Set_22/Validation_Set/" #/b227/ygw/Dcase2022/Development_Set/Validation_Set/
...
if [[ $1 == 0 ]] || [[ $1 == 1 ]];then
    ...
    cd ../evaluation_metrics
    python -m evaluation -pred_file=../src/src/output_csv/ori/Eval_out_ori_post.csv -ref_files_path=$ref_files_path_ -team_name=PKU_ADSP -dataset=VAL -savepath=../evaluation_metrics/
    cd ../src
fi